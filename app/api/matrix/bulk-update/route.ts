...
export async function POST(request: Request) {
  ...
  await trackLegacyPathInvocation({ pathKey: LEGACY_PATH_KEYS.matrixBulkUpdate, route: '/api/matrix/bulk-update', method: 'POST', userId: auth.user.id, details: { countryId, byProductIds: !!productIds?.length } });
